...
export function Footer() {
  return (
    <footer className="mt-auto flex flex-col gap-16 bg-[#1C1C20] px-8 py-16 lg:gap-32 lg:px-18">
      <div className="flex flex-col gap-8 lg:flex-row lg:items-start">
        <div className="flex flex-col gap-5 lg:w-1/2">
          <LogoFull className="h-12 w-auto lg:h-16" fill="#F4F4F2" />
          <p className="font-light text-base leading-5 text-[#F4F4F2]/70">
        ...
        <div className="flex flex-1 justify-end">
          <div className="flex gap-16">
            <div className="flex flex-col items-end gap-2">
              <span className="font-semibold text-base leading-5 text-[#F4F4F2]">
                Social
              </span>
              <Link
                href="https://x.com/runnel"
                className="text-base leading-5 text-[#F4F4F2] transition-opacity hover:opacity-80"
              >
                X
              </Link>
              <Link
