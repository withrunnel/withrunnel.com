      ...
      <div className="flex flex-col gap-8">
        <section>
          ...
          <p className="text-base leading-7 text-muted">
            ...
            personal data collected through the Runnel Waitlist at
            withrunnel.com.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-base leading-7 text-muted">
            We retain your data for the duration of the waitlist period. When
            you unsubscribe, your personal data is immediately anonymized or
            deleted. Audit logs are retained for 2 years for security
            compliance.
          </p>
        </section>
